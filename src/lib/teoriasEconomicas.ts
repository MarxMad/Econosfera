...
export const TEORIAS_ECONOMICAS: EventoTeoria[] = [
  ...
  { year: 1950, autor: "Raúl Prebisch", nombre: "Estructuralismo Latinoamericano", descripcion: "Teoría del deterioro de los términos de intercambio (tesis Prebisch-Singer) y el modelo de industrialización por sustitución de importaciones (ISI).", tipo: "teoria", obra: "El desarrollo económico de la América Latina y algunos de sus principales problemas" },
...
export const CRISIS_FINANCIERAS: EventoCrisis[] = [
  ...
  { year: 1866, autor: "Reino Unido", nombre: "Pánico de 1866", descripcion: "Colapso del banco Overend, Gurney & Company, el 'banco de los banqueros' en Londres, enviando ondas de choque por todo el sistema financiero mundial.", tipo: "crisis" },
  ...
  { year: 1890, autor: "Argentina / Baring Brothers", nombre: "Pánico de 1890", descripcion: "Gran crisis en Argentina que casi lleva a la quiebra al banco Baring Brothers en Londres, tras una burbuja de tierras y deuda.", tipo: "crisis" },
  { year: 1907, autor: "EE.UU. / J.P. Morgan", nombre: "Pánico de 1907", descripcion: "Crisis de liquidez en Wall Street que llevó a la creación de la Reserva Federal (FED) en 1913 después de que J.P. Morgan rescatara personalmente al sistema.", tipo: "crisis" },
  ...
  { year: 1982, autor: "Latinoamérica", nombre: "Crisis de la Deuda Externa", descripcion: "La 'Década Perdida' en América Latina. México declaró la moratoria, seguida por otros países, debido al alza de tasas en EE.UU. y deuda insostenible.", tipo: "crisis" },
  { year: 1982, autor: "Chile", nombre: "Crisis Económica de 1982", descripcion: "La peor crisis en Chile desde los años 30, con una caída del PIB del 14% y el colapso del sistema financiero tras un periodo de tipo de cambio fijo.", tipo: "crisis" },
  ...
  { year: 1990, autor: "Japón", nombre: "Burbuja de Activos Japonesa", descripcion: "Estallido de la burbuja inmobiliaria y bursátil en Japón, dando inicio a la 'Década Perdida' japonesa de estancamiento económico.", tipo: "crisis" },
  { year: 1992, autor: "Reino Unido / Europa", nombre: "Miércoles Negro", descripcion: "Ataque especulativo contra la libra esterlina (liderado por George Soros) que forzó la salida del Reino Unido del Mecanismo de Tipos de Cambio Europeo.", tipo: "crisis" },
  { year: 1994, autor: "México", nombre: "Error de Diciembre (Efecto Tequila)", descripcion: "Crisis de divisas por la devaluación del peso mexicano que se contagió a otros mercados emergentes, requiriendo un rescate financiero masivo.", tipo: "crisis" },
  ...
  { year: 1998, autor: "Rusia", nombre: "Crisis del Rublo", descripcion: "Rusia devaluó el rublo y declaró moratoria de su deuda tras la crisis asiática y la caída de precios del petróleo, afectando a fondos como LTCM.", tipo: "crisis" },
  { year: 1999, autor: "Brasil", nombre: "Efecto Samba", descripcion: "Crisis cambiaria en la que Brasil abandonó el tipo de cambio fijo ante ataques especulativos, provocando una fuerte devaluación del real.", tipo: "crisis" },
  { year: 1999, autor: "Colombia", nombre: "Crisis Financiera Colombiana", descripcion: "La recesión más profunda en la historia moderna de Colombia, marcada por el colapso del sistema UPAC y una crisis hipotecaria severa.", tipo: "crisis" },
  ...
  { year: 2001, autor: "Argentina", nombre: "El Corralito", descripcion: "Gran crisis económica y social en Argentina tras el fin de la convertibilidad, restricción de retiros bancarios y cese de pagos de la deuda.", tipo: "crisis" },
  { year: 2001, autor: "Global", nombre: "Atentados 9/11", descripcion: "Aunque fue un evento terrorista, provocó el cierre de los mercados por una semana y una recesión global que cambió las políticas de seguridad y defensa.", tipo: "crisis" },
  ...
  { year: 2009, autor: "Eurozona", nombre: "Crisis de la Deuda Europea", descripcion: "Crisis de deuda soberana en Grecia, Irlanda, Portugal, España e Italia que puso en riesgo la estabilidad del Euro y requirió rescates del FMI/BCE.", tipo: "crisis" },
  { year: 2014, autor: "Brasil", nombre: "Crisis Económica de 2014", descripcion: "Profunda recesión en Brasil causada por la caída de los precios de las materias primas y crisis política, marcando el fin del periodo de gran crecimiento.", tipo: "crisis" },
  { year: 2016, autor: "Venezuela", nombre: "Hiperinflación Venezolana", descripcion: "Una de las peores crisis inflacionarias de la historia moderna, destruyendo el valor del Bolívar y provocando una migración masiva.", tipo: "crisis" },
  ...
  { year: 2022, autor: "Cripto / FTX", nombre: "Cripto-Invierno", descripcion: "Colapso del ecosistema Terra/Luna y la quiebra de FTX, borrando billones de dólares en capitalización del mercado de criptoactivos.", tipo: "crisis" },
  { year: 2023, autor: "EE.UU. / Suiza", nombre: "Crisis Bancaria Regional", descripcion: "Colapso de Silicon Valley Bank (SVB) y la compra de emergencia de Credit Suisse, despertando temores de contagio financiero global.", tipo: "crisis" },
];
