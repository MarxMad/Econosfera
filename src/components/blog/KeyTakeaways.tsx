...
export default function KeyTakeaways({ points }: KeyTakeawaysProps) {
    return (
        <div className="my-8 sm:my-10 p-5 sm:p-8 rounded-xl sm:rounded-[2rem] bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/50 relative overflow-hidden">
