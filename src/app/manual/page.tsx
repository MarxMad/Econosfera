            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto text-lg">
                        Aprende a aprovechar al máximo los simuladores económicos, la Inteligencia Artificial y la generación de reportes profesionales en Econosfera.
                    </p>
                </div>
                        ...
                        <div className="bg-slate-900 border border-slate-700 text-white p-6 rounded-2xl flex items-start gap-4 flex-col sm:flex-row">
                            ...
                            <div>
                                ...
                                <ul className="list-disc pl-5 text-sm space-y-1 text-slate-300 mb-4">
                                    ...
                                    <li>Glosarios y descripciones técnicas para directivos.</li>
                                </ul>
